...
const PROMPTS: Record<number, string> = {
  ...
  2: "Thanks. We've captured that. Head to the Asteroid Belt to add evidence when you're ready.",
};

interface LaunchpadStageProps {
  applicationId: string;
  onComplete: () => void;
}

export function LaunchpadStage({ onComplete }: LaunchpadStageProps) {
  ...
  return (
    <PlanetCard
      title="Launchpad — Tell me your story"
      subtitle="Conversational resume. We record what you share."
      badge="Stage 2"
    >
